...
function showModal(evt) {
    const img = document.getElementById('large');
    img.src = picArray[evt.currentTarget.id]['image']['large'];
    img.alt = picArray[evt.currentTarget.id]['title'];

    const dialog = document.getElementById('largeImage');
...
for (let pic of picArray) {
    ...
    art.addEventListener('click', showModal);
    document.getElementById("pictures").appendChild(art);
}

document.getElementById("imgSpan").addEventListener('click', closeModal);
